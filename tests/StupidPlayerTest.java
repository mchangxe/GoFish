...
public class StupidPlayerTest {
    ...
    public void equals() throws Exception {
        StupidPlayer x = new StupidPlayer(0, 0);
        StupidPlayer y = new StupidPlayer(0, 0);
    ...
    public void equals2() throws Exception {
        StupidPlayer x = new StupidPlayer(0, 1);
        StupidPlayer y = new StupidPlayer(0, 2);
